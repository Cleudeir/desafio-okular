...
const VideoPlayerControls = ({ playerHook, theater, defaultWidth, controlElement, currentVideoChange }) => {
    ...
    <div className={styles.container} ref={controlElement}>
      ...
      <div className={styles.controls} >
        ...
        <div className={styles.changeVideo}>
          <button className={styles.icons} onClick={() => { holdOpacityEnter(), resetVideoInfos(); currentVideoChange(-1) }}>
